...
<!-- Button trigger modal -->
    ...
    <button  class="card" data-bs-toggle="modal" data-bs-target="#exampleModal">SIGN IN</button>
        

    <button   class="card" data-bs-toggle="modal" data-bs-target="#exampleModal">SIGN UP</button>
