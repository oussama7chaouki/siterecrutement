...
<div class="header">
      <div class="side-nav">
         ...
         <ul class="nav-links" style="margin-left: -16px;">
            <li> <a href="<?php echo "/".basename(dirname(__FILE__))."/profil.php" ?>"><i class="fa-solid fa-house"></i><span>Home</span></a></li>
          <li> <a href="<?php echo "/".basename(dirname(__FILE__))."/testupload/moncv.php" ?>"><i class="fa fa-briefcase"></i><span>Mon Cv</span></a></li> 
